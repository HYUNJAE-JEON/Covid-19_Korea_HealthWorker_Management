...
<div class="middle_title">
	...
	<!-- 두번째 아이디 줄 -->
		<tr>
			...
			<td><input type="text" size="30" maxlength="12" placeholder="4~12자의 영문 대소문자,숫자만 입력" value="${workerDto.wId}" readonly>  </td>
		</tr>
	<!-- 세번째 비밀번호 줄 -->
		<tr>
	...
	<!-- 네번째 줄 -->
		...
		<tr>
			...
			<td><input type="number" name="wPhone_number" id="wPhone_number" value="${workerDto.wPhone_number}" size="20" placeholder="'-' 기호 빼고 입력"></td>
		</tr>			
		<!-- 아호번째 줄 -->
		<tr>
		...
		<!-- 열두번째 줄 -->
		<tr>
			<td align="center" bgcolor="D5D5D5"><span style= "font-size:7px; color: #ff7f00">*</span>자격번호</td>
		...
		<tr>
			...
			<input type="text" disabled size="4" value="${workerDto.wClinical_experience}">년
		...
		<tr>
			...
			<input type="text" disabled size="4" value="${workerDto.wMajor_career_years}">년
		...
		<tr>
			...
			<td><input type="text" name="wMajor_career_institution" id="wMajor_career_institution" size="20" placeholder="가장 길게 근무한 기관 입력 " value="${workerDto.wMajor_career_institution}" ></td>
		</tr>
		<tr>
		...
		<tr>
			<td align="center" bgcolor="D5D5D5"><span style= "font-size:7px; color: #ff7f00">*</span>코로나 파견의료 경험<br></td>
			<td>
	...
	<div align="center">
	<input class="button" type="button" value="수정" onclick="infoConfirm()">&nbsp;&nbsp;&nbsp; <input type="reset" value="취소" class="button" onclick="javascript:window.location='worker_recruitment_view'">
	</div>
	</form>
